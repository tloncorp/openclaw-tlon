...
function shouldShowConfigured(provider) {
...
function formatAccountLine(params) {
    ...
    if (shouldShowConfigured(provider) &&
...
export async function providersListCommand(opts, runtime = defaultRuntime) {
    ...
    const authProfiles = Object.entries(authStore.profiles).map(([profileId, profile]) => ({
        ...
        type: profile.type,
        isExternal: profileId === CLAUDE_CLI_PROFILE_ID ||
