...
export type ConnectionCompleteStatusKey = 'yes' | 'crash' | 'no-data' | 'no-dns' | 'no-our-planet' | 'no-our-galaxy' | 'no-sponsor-hit' | 'no-sponsor-miss' | 'no-their-galaxy';
export interface CompleteStatus {
    complete: ConnectionCompleteStatusKey;
}
export type ConnectionCompleteStatus = Connected | YetToCheck | Crash | NoDNS | NoOurPlanet | NoOurGalaxy | NoSponsorHit | NoSponsorMiss | NoTheirGalaxy;
export type ConnectionPendingStatusKey = 'setting-up' | 'trying-dns' | 'trying-local' | 'trying-target' | 'trying-sponsor';
...
export type ConnectionStatus = ConnectionCompleteStatus | ConnectionPendingStatus;
