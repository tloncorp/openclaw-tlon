...
export type PostDeliveryStatus = 'enqueued' | 'pending' | 'sent' | 'failed' | 'needs_verification';
...
export declare function isGroupEvent(event: ActivityEvent): event is GroupEvent;
export declare function isSystemContact(contact: Contact | SystemContact): contact is SystemContact;
export declare const SETTINGS_SINGLETON_KEY = "settings";
export declare const BASE_UNREADS_SINGLETON_KEY = "base_unreads";
export type Chat = {
    id: string;
    pin: Pin | null;
...
export declare const hostingAuthToken: StorageItem<string>;
export declare const hostingUserId: StorageItem<string>;
