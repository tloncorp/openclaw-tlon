 ...
 */
export declare function getConstants(): Constants;
/**
 * Configure constants programmatically (useful for standalone usage).
 */
export declare function configureConstants(constants: Partial<Constants>): void;
export declare function isOpenRouterConfigured(): boolean;
