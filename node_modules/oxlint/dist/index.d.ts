 ...
 */
type OxlintEnv = Record<string, boolean>;
/**
 ...
 */
type OxlintGlobals = Record<string, GlobalValue>;
 ...
 */
type DummyRuleMap = Record<string, DummyRule>;
/**
 ...
 */
declare const definePlugin: typeof definePlugin$1;
/**
 * @deprecated Import from `oxlint/plugins` instead
 */
declare const defineRule: typeof defineRule$1;
/**
 * @deprecated Import from `oxlint/plugins-dev` instead
 */
declare const RuleTester: typeof RuleTester$1;
//#endregion
export { type AllowWarnDeny, type DummyRule, type DummyRuleMap, type ExternalPluginEntry, type ExternalPluginsConfig, type OxlintConfig, type OxlintEnv, type OxlintGlobals, type OxlintOverride, type RuleCategories, RuleTester, defineConfig, definePlugin, defineRule };